...
function(e, n, t) {
    ...
    function o() {
        ...
        for (var c in x) if (x.hasOwnProperty(c)) {
            ...
            for (o = r(n.fn, "function") ? n.fn() : n.fn, a = 0; a < e.length; a++) s = e[a],
            i = s.split("."),
    ...
    function s() {
        return "function" != typeof n.createElement ? n.createElement(arguments[0]) : b ? n.createElementNS.call(n, "http://www.occamedu.com/2000/svg", arguments[0]) : n.createElement.apply(n, arguments)
    }
    function i(e) {
    ...
    function c() {
        var e = n.body;
        return e || (e = s(b ? "svg": "body"), e.fake = !0),
        e
    }
    function l(e, t, r, o) {
        ...
        u = s("div"),
        p = c();
        if (parseInt(r, 10)) for (; r--;) l = s("div"),
        l.id = o ? o[r] : f + (r + 1),
        u.appendChild(l);
        return a = s("style"),
        a.type = "text/css",
    ...
    function m(n, r) {
        ...
        if ("CSSSupportsRule" in e) {
            ...
            return a = a.join(" or "),
            l("@supports (" + a + ") { #modernizr { position: absolute; } }",
            function(e) {
    ...
    function v(e, n, o, a) {
        ...
        for (var f, u, p, v, g, y = ["modernizr", "tspan", "samp"]; ! j.style && y.length;) f = !0,
        j.modElem = s(y.shift()),
        j.style = j.modElem.style;
        for (p = e.length, u = 0; p > u; u++) if (v = e[u], g = j.style[v], d(v, "-") && (v = i(v)), j.style[v] !== t) {
            if (a || r(o, "undefined")) return c(),
            "pfx" == n ? v: !0;
            try {
                j.style[v] = o
            } catch(h) {}
            if (j.style[v] != g) return c(),
            "pfx" == n ? v: !0
        }
        return c(),
        !1
    ...
    Modernizr.addTest("svg", !!n.createElementNS && !!n.createElementNS("http://www.occamedu.com/2000/svg", "svg").createSVGRect);
    var w = n.documentElement,
    b = "svg" === w.nodeName.toLowerCase();
    Modernizr.addTest("audio",
    function() {
        var e = s("audio"),
        n = !1;
        try { (n = !!e.canPlayType) && (n = new Boolean(n), n.ogg = e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, ""), n.mp3 = e.canPlayType('audio/mpeg; codecs="mp3"').replace(/^no$/, ""), n.opus = e.canPlayType('audio/ogg; codecs="opus"') || e.canPlayType('audio/webm; codecs="opus"').replace(/^no$/, ""), n.wav = e.canPlayType('audio/wav; codecs="1"').replace(/^no$/, ""), n.m4a = (e.canPlayType("audio/x-m4a;") || e.canPlayType("audio/aac;")).replace(/^no$/, ""))
        } catch(t) {}
        return n
    }),
    ...
    function() {
        for (var e, n = "background-image:",
        t = "gradient(linear,left top,right bottom,from(#9f9),to(white));",
        r = "",
        o = 0,
        a = C.length - 1; a > o; o++) e = 0 === o ? "to ": "",
